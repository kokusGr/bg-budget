...
CREATE TABLE "public"."Transactions" (
    ...
    "boardgame" character varying,
    "date" "date",
    "type" character varying,
    "amount" real,
    "boardgame_sent" character varying,
    "amount_sent" real,
    "owner_id" "uuid" DEFAULT 'c7ced97b-f28d-49db-957d-c23de1a96e29'::"uuid" NOT NULL
);
...
--
-- Name: Transactions Transactions_owner_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: supabase_admin
--
...
--
-- Name: Transactions Allow access to only owned transactions; Type: POLICY; Schema: public; Owner: supabase_admin
--

CREATE POLICY "Allow access to only owned transactions" ON "public"."Transactions" USING (("auth"."uid"() = "owner_id")) WITH CHECK (true);
